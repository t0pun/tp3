...
public class ProduitTest {
    ...
    private static void performRandomOperation(String userId) {
        logger.info("Méthode performRandomOperation exécutée.");;
    ...
    private static void readProducts() {
        logger.info("Méthode readProducts exécutée.");;
    ...
    private static void updateRandomProductPrice() {
        logger.info("Méthode updateRandomProductPrice exécutée.");;
        ...
        // Filtre pour trouver le produit par son nom
        // Mise à jour du prix
        produitsCollection.updateOne(Filters.eq("nom", nomProduit), Updates.set("prix", newPrice));
    ...
    private static void searchMostExpensiveProduct() {
        logger.info("Méthode searchMostExpensiveProduct exécutée.");;
        // Utilisation de l'agrégation pour trier les produits par prix décroissant
        AggregateIterable<Document> result = produitsCollection.aggregate(// Trier par prix décroissant
        // Limiter à un seul produit (le plus cher)
        Arrays.asList(new Document("$sort", new Document("prix_produit", -1)), new Document("$limit", 1)));
    ...
    private static void saveUserProfilesToJSON() {
        logger.info("Méthode saveUserProfilesToJSON exécutée.");;
