...
public class Tp3bApplication {
    private static final Logger logger = LoggerFactory.getLogger(Tp3bApplication.class);
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Produit p = new Produit("pigeon", 12.0, "2000-03-12");
        Produit p2 = new Produit("cochon", ((double) (22.0)), "2001-03-12");
